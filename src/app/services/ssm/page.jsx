            ...
            >
                ...
                <div className="min-h-screen flex items-center relative w-full overflow-visible">
                    ...
                    <div className="">
                        <div className="relative z-10 ml-20 max-lg:ml-5">
                            ...
                            <h1 className="text-[clamp(30px,12vw,82px)] font-normal font-sora uppercase mb-4 tracking-tight leading-[81px] text-white">
                        ...
                        <img
                            ...
                            className="absolute w-[45%] h-auto -bottom-15 right-30"
                ...
                <div>
                    ...
                    <div className="bg-no-repeat" style={{ backgroundImage: 'url(/images/services/bg-gradient.png)' }}>
                        <section id="ssm" className="pt-64 pb-20">

            ...
            <div className="min-h-screen flex items-center relative w-full overflow-hidden">
                ...
                <div className="">
                    <div className="relative z-10 ml-20 max-lg:ml-5">
                        ...
                        <h1 className="text-[clamp(30px,12vw,70px)] font-normal font-sora uppercase mb-4 tracking-tight leading-[81px] text-white">
                            <AuroraText colors={["#ffffff", "#d1bd73"]}>
                                Branding <br /> Brands That Shape You {" "}
                            </AuroraText>
                            <span className="text-[clamp(40px,12vw,80px)] font-thin text-end items-end max-lg:text-start max-lg:items-start block">
                    ...
                    <div className="absolute w-4/6 top-40 -right-60 z-10">
                        <img

    ...
    return (
        <SmoothScroll>
            ...
            >
                    ...
                    <div className="flex max-lg:flex-col max-lg:mt-10 items-center gap-8 mt-36">
                        <div className="z-10 ml-20 max-lg:ml-5">
                            <div className="mb-16 flex items-center gap-3 text-sm text-white/80">
                                ...
                                <p className="font-bold text-lg">Mobile Applications</p>
                            </div>
                            ...
                            <p className="font-light text-white/70 text-sm md:text-md lg:text-xl max-lg:px-1">
                                From ideas to app release we design and build mobile apps that show who you are on screen
                            </p>
                        </div>

                        <img
                            src="/images/services/mobile-applications/hero.png"
                            className="absolute w-2/5 top-40 right-0 z-10 max-lg:relative max-lg:top-0 max-lg:right-0 h-auto"
                ...
                <div className="relative z-10 mt-20 py-5 px-24 max-lg:p-2 justify-center flex">
                    <video
                        autoPlay
                        loop
                        muted
                    ...
                    >
                        <source src="/images/services/mobile-applications/section-2.mp4" type="video/mp4" />
                    </video>
                </div>
                ...
                <div>
                    ...
                    <div className="bg-no-repeat" style={{ backgroundImage: 'url(/images/services/bg-gradient.png)' }}>
                        <section id="mobile-applications" className="pt-64 pb-20">
                            ...
                            <div id="mobile-applications-layout" className="my-20">
                                ...
                                <style jsx global>{`
                                    ...
                                    #mobile-applications #mobile-applications-layout .grid > div > div .absolute.bottom-0.left-0.right-0 {

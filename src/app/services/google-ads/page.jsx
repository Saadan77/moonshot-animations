        ...
        <SmoothScroll>
            ...
            >
                    ...
                    <div className="flex max-lg:flex-col max-lg:mt-10 items-center gap-8 mt-36">
                        <div className="z-10 ml-20 max-lg:ml-5">
                            ...
                            <p className="font-light text-white/70 text-sm md:text-md lg:text-xl max-lg:px-1">
                                We run clever Google Ads campaigns that drive targeted traffic and real online growth
                            </p>
                        </div>

                        <img
                            src="/images/services/google-ads/hero.png"
                            className="absolute top-40 right-0 z-10 max-lg:relative max-lg:top-0 max-lg:right-0 h-auto"
                            alt="Google Ads Hero"
                ...
                <div className="relative mt-24 py-5 px-24 max-lg:p-2 z-10 justify-center flex">
                    ...
                    >
                        <source src="/images/services/google-ads/section-2.webm" type="video/webm" />
                    </video>
                </div>
                ...
                <div>
                    ...
                    <div className="bg-no-repeat" style={{ backgroundImage: 'url(/images/services/bg-gradient.png)' }}>
                        <section id="google-ads" className="pt-64 pb-20">
                            ...
                            <div id="google-ads-layout" className="my-20">
                                ...
                                <style jsx global>{`
                                    ...
                                    #google-ads #google-ads-layout .grid > div > div .absolute.bottom-0.left-0.right-0 {

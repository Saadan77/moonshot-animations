...
const AboutUs = () => {
    ...
    return (
        <section className="relative isolate w-full overflow-visible bg-black text-white z-10">
            <div className="mx-auto max-w-[90%] px-6 sm:px-8 md:px-10 lg:px-12 py-24 md:py-28 lg:py-32">
                ...
                <div className="relative mt-14 lg:mt-20">
                    ...
                    <div
                        className="pointer-events-none absolute -bottom-14 left-1/2 -z-10 h-[230px] w-screen -translate-x-1/2 blur-[60px] opacity-90"
                        style={{
                            background:

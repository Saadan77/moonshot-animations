...
export default function Testimonials() {
    const testimonials = [
        ...
        },
        {
            ...
            quote:
                '"Their team embedded seamlessly with ours, simplifying roadmaps and shipping on time. The results exceeded our projections and expectations. A truly collaborative partnership that delivered excellent value."',
            src: '/images/testimonial-image.png',
        },
        {
            name: 'James Patel',
    ...
    return (
        <section
            className="relative bg-[#00060B] mt-60"
            style={{ fontFamily: 'var(--font-sora), sans-serif' }}
        >
            {/* DottedMap Background */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0" />
                <img src="/images/testimonials-map.png" alt="Dotted Map" className="w-full h-full object-contain" />
            </div>

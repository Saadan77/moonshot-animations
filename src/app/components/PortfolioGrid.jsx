      ...
      <div className="max-w-[90%] sm:max-w-[80%] md:max-w-[85%] lg:max-w-[95%] mx-auto">
            ...
            <div className="flex flex-wrap gap-6 max-xl:gap-4 justify-center">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`relative z-10 px-12 max-xl:px-8 py-4 rounded-full text-lg max-1440:text-base max-1366:text-sm max-1280:text-xs transition-all ${
                    activeTab === tab.value
        ...
        <div className="relative z-50 grid grid-cols-1 lg:grid-cols-2 gap-12 max-md:gap-24">
          {filteredItems.map((item, index) => (
            <div
              key={item.id}
              className={`bg-black p-27 max-1600:p-25 max-1440:p-20 max-1336:p-16 max-xl:p-14 max-sm:p-5 rounded-4xl relative group h-[95vh] max-1440:h-[85vh] max-1366:h-[80vh] max-1280:h-[75vh] max-xl:h-[60vh] ${
            ...
            >
              ...
              <h3 className="relative mt-5 max-2xl:mt-3 max-1280:mt-2 -ml-15 max-2xl:-ml-10 max-xl:-ml-5 text-white text-[clamp(30px,3vw,48px)] font-light tracking-tighter">
                {item.title}
              </h3>
            </div>
          ))}

                ...
                <div className="-mt-10 py-50 bg-[#00050A] rounded-[34.137px] relative z-10">
                    <div className="max-w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-7 items-start gap-16">
                        ...
                        <form className="col-span-4">
                            <div style={{ background: "#011322" }} className="rounded-2xl mx-6 p-18 max-lg:p-8 max-sm:p-5">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-poppins font-normal text-white text-sm">
                                    <input placeholder="Email" className="w-full rounded-[90px] py-3 px-4 bg-[#000911] border border-[#18354D] outline-none" />
                                    <input placeholder="Full Name" className="w-full rounded-[90px] py-3 px-4 bg-[#000911] border border-[#18354D] outline-none" />
                                </div>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 font-poppins font-normal text-white text-sm">
                                    <input placeholder="Project Budget" className="w-full rounded-[90px] py-3 px-4 bg-[#000911] border border-[#18354D] outline-none" />
                                    <input placeholder="Business Name" className="w-full rounded-[90px] py-3 px-4 bg-[#000911] border border-[#18354D] outline-none" />
                                </div>

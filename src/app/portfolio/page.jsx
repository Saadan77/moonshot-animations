...
export default function Portfolio() {
    return (
        ...
        >
            ...
            <div className="h-screen flex justify-center items-center relative w-full overflow-hidden bg-black">
                {/* Dither Background */}
                ...
                <div className="max-w-[90%] flex items-center justify-center gap-8">
                    ...
                    <div style={{ mixBlendMode: "screen" }} className="z-100"><MacModel /></div>
                </div>
            </div>
